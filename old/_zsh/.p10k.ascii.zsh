# Generated by Powerlevel10k configuration wizard on 2023-05-24 at 14:51 AEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 57945.
# Wizard options: ascii, rainbow, 24h time, 1 line, compact, concise,
# instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_MAX_INDEX_SIZE_DIRTY=80000
